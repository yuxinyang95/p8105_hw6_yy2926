...
For the question, I choose a regression model based on a hypothesized structure for the factor. I choose six variables which may have direct relationship with the infant's birthweight. From the residual vs prediction plots, we can observed that most obsrevation are located in the lower right. 
